  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <img 
          src="https://images.unsplash.com/photo-1565204310168-501404c04cec?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=MnwxfDB8MXxyYW5kb218MHx8YW5pbWV8fHx8fHwxNjk0MTAzMTM0&ixlib=rb-4.0.3&q=80&utm_campaign=api-credit&utm_medium=referral&utm_source=unsplash_source&w=1080" 
        ...
        <div className="animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
            ...
            <Link to="/shop?category=figure">
              <Button variant="outline" className="rounded-full border-white text-white hover:bg-white/10 transition-all px-8 py-6 text-lg">
                View Figures
              </Button>
            </Link>
          </div>
      ...
      <div className="absolute right-20 top-1/3 w-60 h-60 bg-primary-100/10 rounded-full filter blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      <div className="absolute bottom-10 left-1/3 w-40 h-40 bg-primary-700/10 rounded-full filter blur-3xl animate-float" style={{ animationDelay: '2s' }}></div>
    </div>
  );
};
